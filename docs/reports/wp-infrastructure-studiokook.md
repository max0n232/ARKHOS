...
```json
{
  "@type": "FurnitureStore",
  "name": "Studioköök",
  "description": "Kohandatud köögimööbel Tallinnas...",
...
| 2776 | `/meie-toopinnad/` (töötasapinnad) | Столешницы | Elementor | **404! Страница не найдена** |
...
| 6 | Tööpind Tehnostone | Столешницы Technistone | Каменные столешницы |
